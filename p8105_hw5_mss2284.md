...
difference in y axes. As demonstrated in the tables below, the null was
rejected a different proportion of time for each beta, with greater
proportions for beta = 5 and 6. This may have led to a difference in the
sample average.
