...
The sample average of Beta1 across tests for which the null is rejected is not approximately equal to the true value of Beta1, as seen by the overlay plot below. The sample average of beta1 across tests for which the null is rejected is greater than the true value of beta1, and greater than the sample average overall (including the tests where the null was not rejected).
...
As demonstrated in the figure above, "Proportion of times null rejected", the null was rejected with higher proportions for higher values of Beta1, greater than 3. This may have led to a difference in the sample average. With significant p values, you are rejecting the null hypothesis that Beta1 = 0, that the mean estimated Beta1 is not equal to the true Beta1. For higher true values of Beta1, the mean estimated Beta1 values that have p values < 0.05 are farther away from 0 and drive the difference between the overall and significant average estimates.
