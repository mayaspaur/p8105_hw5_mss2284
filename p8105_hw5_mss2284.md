...
in the tables below, the null was rejected a different proportion of
time for each beta, with greater proportions for beta = 5 and 6. This
led to a difference in the sample average.
