...
The sample average of Beta1 across tests for which the null is rejected is not approximately equal to the true value of Beta1. As demonstrated in the tables below, the null was rejected a different proportion of time for each beta, with greater proportions for beta = 5 and 6. This led to a difference in the sample average.
